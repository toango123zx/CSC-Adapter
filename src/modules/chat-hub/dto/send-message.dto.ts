...
export class SendMessageDto {
  @ApiProperty({
    enum: Platform,
    description: 'Nền tảng đích muốn gửi (TELEGRAM hoặc LIVECHAT)',
  })
  @IsEnum(Platform)
  platform!: Platform;

  @ApiProperty({
    description: 'ID cuộc hội thoại (Telegram Chat ID hoặc LiveChat Chat ID)',
    example: '123456789',
  })
  @IsNotEmpty()
  @IsString()
  ...
  @ApiProperty({
    ...
    example: 'Chào bạn, đơn hàng của bạn đã được đóng gói!',
  })
  @IsNotEmpty()
  @IsString()
  text!: string;
